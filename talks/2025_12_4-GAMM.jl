...
# ╔═╡ db943cd2-cb95-11f0-3794-d986ab2e63bb
begin
	using PlutoUI, PlutoTeachingTools
	using PlutoUI: Slider
end

# ╔═╡ dd02da66-c622-439e-88f8-f9156c61130e
begin
	using CairoMakie
...
# ╔═╡ 120da76b-697d-483b-a7e9-9d40ac61ad9d
ChooseDisplayMode()

# ╔═╡ d385a736-3ebe-4208-a4c1-e2b825c4049b
html"""
<h1> Julia for Research Software Engineering  </h1>

<div style="text-align: center;">
Dec 4th 2025 <br>
GAMM RSE & RDM
<br><br>
<u>Valentin Churavy</u>, Hendrik Ranocha, Michael Schlottke-Lakemper
<br><br>
...
# ╔═╡ 224da4e0-6771-404a-8251-a589d832ee24
md"""
## Julia for research software engineering
"""

# ╔═╡ 11dc0c42-accb-4c1e-b120-9f5e14930bad
md"""
### What's Julia? 🟢 🟣 🔴
...
# ╔═╡ d98b46fe-ab76-418d-aba1-412f27197374
md"""
## Why Julia? 😍
...
# ╔═╡ 6c6d5381-a599-4007-a2eb-6ef0b29aa7eb
md"""
## Julia for RSEs?
...
# ╔═╡ fa168114-31f7-47ee-ba5c-6ef1408dfda9
md"""
[![](https://api.mightyshare.io/v1/19EIFDUEL496RA3F/1337/go-1.png?unique=1&height=630&width=1200&color=f39c12&style=dark&template=go-1&url=https://www.nature.com/articles/d41586-019-02310-3)](https://www.nature.com/articles/d41586-019-02310-3)
"""

# ╔═╡ 0dde3a2e-9770-4e30-ae65-be3aeb797b9a
md"""
...
# ╔═╡ 43e0a811-0654-4e2a-bf5c-b10bc235bc3f
md"""
## A brief introduction to Julia
"""

# ╔═╡ 63dd9b62-7c12-4ca2-8f1b-e257aed6551b
import ForwardDiff

# ╔═╡ 8549b35e-96af-4285-80ef-bbec67ab388f
md"""
### The Newton method in 1D
based of https://featured.plutojl.org/computational-thinking/newton.html
"""

# ╔═╡ 7f7362a4-7a39-48fd-8862-61aff692d551
md"""
...
# ╔═╡ e76f8acd-273b-4356-ad2e-8c7faa598877
md"""
...
# ╔═╡ c9aef4b1-43ce-4041-900c-704a664e41c9
straight(x0, y0, x, m) = y0 + m * (x - x0)

# ╔═╡ aba9aa13-4780-437b-99cd-143f16df2e72
...
# ╔═╡ d87e8671-b6f8-4494-8f4f-7f074135f804
let
	f(x) = x^2 - 2
...
# ╔═╡ fda80f38-918b-48d2-ac54-abbc7c7a4eed
let
	f(x) = 0.2x^3 - 4x + 1
...
# ╔═╡ edd7d6ef-142c-4ab8-862d-f1122b80684b
md"""
## Interoperability: Interaction with other languages

| Language | Julia Tool | Embed Julia |
| -------- | ---------- | ----------- |
| C        | `@ccall` & Clang.jl | Yes (Julia C-ABI) | 
| Fortran  | `@ccall` | Yes (via C ABI) |
| C++      | CxxWrap.jl | Yes (via C ABI) |
| Python   | PythonCall.jl | juliacall Python package |
| R        | RCall.jl | JuliaCall R package |
"""

# ╔═╡ 8b0f15e0-d464-4e12-875c-73088997df59
md"""
## Reproducibility
"""

# ╔═╡ a656f5a1-ae57-4d4b-ad77-e07e96d194ae
TwoColumn(
	question_box(
md"""
Does my code **execute** on another computer
		
Can someone else use it without my intervention?
"""), 
question_box(
"""
Do we arrive at the same results?
""")
)

# ╔═╡ 1294827b-56e2-4f31-bfbc-a65e21b5c842
md"""
...
# ╔═╡ 15160c7f-f528-4dad-bd6c-8a09763cca98
md"""
### Julia's package manager & environments
"""

# ╔═╡ 0f35330d-62c8-4e33-ba8c-c6b62cb10462
md"""
### Package manager
...
# ╔═╡ da4f682c-7029-4e08-a7b0-c49dbebee532
md"""
!!! note
    In Pluto the package-manager is tightly integrated. This leads to reproducible note-books!
"""

# ╔═╡ bfa7815c-7cf6-43ed-9035-8123edbaea88
md"""
```sh
...
# ╔═╡ a1d0d211-c998-4e51-9bd2-7bfaabdb1c74
md"""
#### Project.toml
...
# ╔═╡ 4f19fecc-4ec1-4e1c-a546-c3fb2ca70c93
md"""
...
# ╔═╡ 9b10acb5-787d-41e1-a364-e5dbd3535a88
md"""
...
# ╔═╡ aff9ebd9-9b55-4f0d-b3e5-85f4a3f5a0a8
md"""
...
# ╔═╡ 98c161cb-2448-4e67-9d5d-168332f1761b
md"""
!!! note
    `Project.toml` encodes what the developer *thinks* their compatibilities are, but are not sufficient for true reproduction. 
"""

# ╔═╡ c5224146-c094-4ddc-a44f-a1bc0d616146
md"""
#### Manifest.toml
...
# ╔═╡ f12e59fd-37a8-4919-b7f5-618b18a74f6b
md"""
!!! note
...
# ╔═╡ 2ca85e00-5247-4cc9-9812-03d9722f2d03
md"""
### Binaries included
...
# ╔═╡ 7a2bfe92-589e-43f4-b146-85baea412641
md"""
### Workflow
"""

# ╔═╡ 21b3fa43-04c5-4df3-8afb-2d9a14854926
md"""
1. Clone repository
...
# ╔═╡ 6cefec89-ae76-4b12-ad56-e3db40a4596f
md"""
### Reproducibility of results!

!!! warning
    Reproducibility is more complicated than: What are the **versions** of my software packages

1. Random numbers
2. Precision gurantuees of different mathematical libraries
    - We maintain [`openlibm`](https://openlibm.org/) to provide a consistent `libm` implementation across operating systems, compilers and hardware
    - Vendor `libm` likes to cheat ("it's faster")
3. Order of operations due to hardware
    - Vector width impacts order of summation
3. Compiler flags
    - [Beware of fast-math by Simon Byrne](https://simonbyrne.github.io/notes/fastmath/)
"""

# ╔═╡ f0099b2c-72e2-4b8e-af9c-7f1733daf603
html"""
<iframe width="560" height="315" src="https://www.youtube.com/embed/tShA102zIwk?si=Y2y6qo686foXUWWE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
"""

# ╔═╡ 11bb7cd0-e93a-44f6-847b-b830f386cb19
md"""
## Julia as an open-source project
"""

# ╔═╡ a18791f9-4d97-4f8e-8788-e8652db0e335
md"""
### Julia's development cycle
"""

# ╔═╡ 960250a0-e6cc-4d5b-b90c-310736f71723
TwoColumn(
md"""
| Version | Date     | Note |
| --- | ---          | --- |
...
| 1.8 | Aug 17, 2022  | |
| 1.9 | May 07, 2023  | |
| 1.10 | Dec 26, 2023  | LTS |
| 1.11 | Oct 8th, 2024 | | 
| 1.12 | Oct 8th, 2025 | |

""")

# ╔═╡ 9f7dad3d-dc87-4bf4-8288-05d79f61c67b
LocalResource("julia_commits_2025.png")

# ╔═╡ 6b67ca8b-7e6d-4404-8bc1-3d47d382f3ea
md"""
!!! note
    Julia 1.0 lead to a *natural* slow down as development efforts shifted to packages and less *core* language. Providing a stable foundation upon which large projects like Trixi.jl can grow.
"""

# ╔═╡ 6c5ac2db-568b-490f-af53-059e57c78ae0
md"""
## Who develops Julia
...
# ╔═╡ 6cb40c45-ceb3-4602-9255-a14ec9451b18
md"""
## Release process
...
1. Feature freeze
2. Lengthy stabilization phase with community testing
   1. Alpha/Beta releases
   2. Release candidates
3. One LTS and one current release supported

"""

# ╔═╡ cc8f3386-c5f7-4938-b39d-3e878a0d5671
md"""
### Ecosystem verfication
...
# ╔═╡ 2401ebe1-605d-4165-85da-1f8c0ce921e0
md"""
## Semantic versioning
...
# ╔═╡ 22671a80-e424-45bf-b143-6c6ccf166298
md"""
#### Things not covered under semantic versioning

- Changes to optimizations
  - Performance changes
  - Number of allocations
  - In Julia: Type-inference quality
- Runtime decision changes
  - When does Garbage Collection run
  - How is memory allocated
  - How are Julia tasks scheduled

!!! note
    Generally "non-observable" behaviours of systems in contrast to application programming interfaces (API).
"""

# ╔═╡ cc914c2b-a05e-4778-8b9a-063a320bb4ab
md"""
### Hyrum's Law

!!! note
    Any observable behavior of the system -— even if not guaranteed by contract —-will eventually be depended upon by someone.
"""

# ╔═╡ 4cdd728c-995b-4ba0-82a1-69bf7e4722e7
md"""
## Examples of Hyrum's Law
"""

# ╔═╡ 46f810b6-6d81-4c34-ae4a-987a6ace4cfd
md"""
## Tasks
- Julia 1.3 introduced a multi-threaded worker
- `@async` (old) vs `@spawn` (new)
- Used different API to avoid breakage (*sigh*)
- Many programs not automatically thread-safe

Conclusion: Supporting a public API that 
"""

# ╔═╡ 98d25717-d22f-4a21-a105-00a25d62c949
md"""
### Inference changes
- Before Julia 1.8 `@pure` to assert that function has no side-effects
- Julia 1.8: General effect-system & concrete evaluation
- Julia 1.9: partial removal of `@pure` (making it safer)
- Change lead to performance issues for code that relied on old behavior.
- `--check-bounds=false` is a Julia option that was recommended by members of the HPC community (Trixi developers) to their users
- Concrete-evaluation and `--check-bounds=false` fundamentally incompatible --> performance regressions
"""

# ╔═╡ 5ddb8f77-77ad-4fe6-b319-c1600a9d85e8
md"""
## Task and Threads (again)
"""

# ╔═╡ 91e4d746-8557-4da9-89e3-86b1f711db94
TwoColumn(
md"""
Feature: Task migration (moving tasks between threads)
	
Consequence: `Threads.threadid()` no longer constant within a task!

```julia
	states = [... for _ in Threads.nthreads()]
	@threads for ....
		tid = threadid()
	    v = states[tid]
	    ...
...
```
Used to be safe, broke in Julia v1.7 since multiple task can share the same threadid.
""",
md"""
Feature: Foreign thread adoption & interactive threadpools

Consequence:
1. `nthreads` no longer reflects the number of threads in the system.
   Need to use `Threads.maxthreadid`
2. Threadpools change threadid ordering, can't use `1:nthreads()` as an interation, since threadid 1 might be in a different pool.
"""
)

# ╔═╡ 78b0a9f5-9a26-436e-a100-0dbfba0d42ec
md"""
...
>
> Synonyms: **Verschlimmbesserung**

"""

# ╔═╡ ae6f4e69-2e17-4f9a-857e-e5dc1ccee270
md"""
# Notes from Trixi.jl

Trixi is a numerical simulation framework for conservation laws written in Julia.

- Started in 2020
  - CI tests are essential for contributors!
- 37 (internal) +  16 (external) papers
  - Documentation and **examples** are essential for users!
  - Research contacts can be establised via software
- Reproducibility repositories for all papers, talks, and workshops
...
>
> — Anonymous Reviewer, ACM TOMS , 2022
"""

# ╔═╡ b2ae08c0-1744-42b6-b937-33a8c7e2d70f
md"""
## Challenges and open questions
- Zenodo is great if it works, but
  - https://github.com/zenodo/zenodo-rdm/issues/1118

- Reproducibility vs. future reusability?
  - Specific Julia/package versions may scare casual users.
- Enforcing sustainable CSE research via reproducibility
  - New CSE journal: https://link.springer.com/journal/44207
  - But DEAL
- Open-source ecosystems are great, but you have to fix the bugs of other people.
  - Who pays for the costs of software maintenance?
  - Who creates a CI pipeline for heterogeneous hardware?
  - Who provides hardware for performance monitoring in CI?
- Code reviews are essential for collaborative software development.
  - How can we reward code reviews as academic contributions?
  - How can we ensure high-quality via reviews without scaring casual contributors?
"""
...
manifest_format = "2.0"
project_hash = "a484eb76fc84b6ebc9be7b288648c4c077181361"
